...
from wm_infra.env_runtime.session_store import SessionStore
...
class TemporalEnvManager:
    ...
    def __init__(
        ...
        *,
        ...
        catalog: LearnedEnvCatalog | None = None,
    ) -> None:
        ...
        self.catalog = catalog or LearnedEnvCatalog(
            temporal_store,
            device=self.device,
            dtype=self.dtype,
            registry=registry,
